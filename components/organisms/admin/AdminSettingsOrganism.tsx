...
export function AdminSettingsOrganism() {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      {/* 1. EXECUTIVE HEADER DENGAN AKSEN VISUAL (MATCHING ADMIN PROGRAM) */}
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-xs sm:text-sm text-brand-200/90 leading-relaxed">
              Konfigurasi tampilan beranda, tajuk hero section, dan bar pengumuman informasi penting portal digital Yayasan KBM.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        <div className="md:col-span-4 lg:col-span-3 space-y-2">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between">
                  <span className={`text-xs font-bold ${activeTab === "hero" ? "text-white" : "text-brand-950"}`}>
                    Hero Section
                  </span>
                </div>
                <p className={`text-[11px] mt-0.5 truncate ${activeTab === "hero" ? "text-brand-200" : "text-brand-500"}`}>
                  Tajuk utama & tombol CTA
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-1">
                  ...
                  {topBanner.enabled ? (
                    <span className="h-2 w-2 rounded-full bg-emerald-400 shrink-0" title="Aktif" />
                  ) : (
          ...
          <div className="card border border-brand-200/80 bg-brand-50/40 p-4 shadow-xs text-xs space-y-2">
            <div className="font-semibold text-brand-900 flex items-center gap-1.5">
              <span>ℹ️</span> Status Sinkronisasi
            </div>
            <p className="text-[11px] text-brand-600 leading-relaxed">
              {hasChanges ? (
                <span className="text-amber-800 font-medium">
                  ● Ada perubahan input yang belum disimpan ke server.
                </span>
              ) : (
                <span className="text-emerald-700 font-medium">
                  ✓ Semua pengaturan saat ini tersinkron dengan server.
                </span>
              )}
            </p>
          </div>
        ...
        {/* KOLOM KANAN: FORM CONTENT PANEL */}
            ...
            <div className="card overflow-hidden border border-brand-200/80 bg-white shadow-xs">
              ...
              <div className="border-b border-brand-100 bg-brand-50/50 p-5 sm:p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-serif text-base sm:text-lg font-bold text-brand-950">
                    Kustomisasi Hero Section Beranda
                  </h2>
                </div>
                <p className="mt-1 text-xs text-brand-600">
                  Sesuaikan teks tajuk utama, kata kunci aksen zamrud, deskripsi singkat, dan tombol ajakan berwakaf (CTA) yang muncul di puncak halaman utama.
                </p>
              </div>
              ...
              <div className="p-5 sm:p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    ...
                    <TextInput
                      ...
                      hint="Teks miring berwarna hijau zamrud."
                    />
                  </div>
                ...
                <div className="border-t border-brand-100 pt-5 space-y-4">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-brand-800">
                    2. Tombol Aksi (Call To Action Buttons)
                  </h3>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <label className="inline-flex items-center gap-2 cursor-pointer select-none">
                          <span className="text-[11px] font-semibold text-brand-700">
                            {hero.showSecondaryCta ? "Aktif" : "Sembunyi"}
                          </span>
                          <input
                            type="checkbox"
                            className="sr-only"
            ...
            <div className="card overflow-hidden border border-brand-200/80 bg-white shadow-xs">
              ...
              <div className="border-b border-brand-100 bg-brand-50/50 p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-brand-600">
                    Banner bernuansa zamrud yang tampil menempel di atas menu navigasi seluruh situs publik.
                  </p>
                </div>
